...
async function main() {
  ...
  function writeUniforms(mvp, eye) {
    ...
    arr.push(params.kd, params.ks, params.Le, params.La);
    arr.push(params.shin, 0.0, 0.0, 0.0);
    while (arr.length < 32) arr.push(0.0);
    device.queue.writeBuffer(uniformBuffer, 0, new Float32Array(arr));
  }
